              ...
              contents: [
                {
                  type: "text",
                  contents: [
                    { type: "span", text: "แจ้งเตือนเขตปลอดภัย", color: "#FC0303", size: "xl", weight: "bold" },
                  ]
                },
              ...
              contents: [
                {
                  ...
                  action: {
                    ...
                    data: `type=${type}&userLineId=${replyToken}&takecarepersonId=${takecarepersonId}`
                  }
                }
              ]
            }
